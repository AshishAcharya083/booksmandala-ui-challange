...
class WaveSlider extends StatefulWidget {
  ...
  const WaveSlider({
    ...
    this.wavActiveColor = kDisableColor,
    this.wavDeactiveColor = Colors.blueGrey,
    this.sliderColor = const Color(0xFF1A6489),
...
class WaveSliderState extends State<WaveSlider> {
  ...
  static const selectBarWidth = 25.0;
            ...
            child: Container(
              ...
              child: Stack(
                ...
                children: <Widget>[
                  ...
                  Bar(
                    isRightBar: false,
                    myIcon: Icons.keyboard_arrow_left,
                  ...
                  Bar(
                    isRightBar: true,
                    myIcon: Icons.keyboard_arrow_right,
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            ///slider box
            children: [
              // Container(height: 4, color: kSliderColor),
              Expanded(child: Container()),
            ...
            ? Stack(
                ...
                children: [
                  ...
                  Container(
                    ...
                    width: width,
                    child: Center(
                        child: Icon(myIcon, size: 24, color: Colors.white)),
                  ),
                ],
              )
            : Stack(
